...
export default function BlogPostHero({ post, createdAt }: BlogPostHeroProps) {
  ...
  return (
    <section className="relative w-full pb-4 pt-32 md:pb-16 md:pt-52">
      ...
      <div className="pointer-events-none absolute inset-0 z-[-2] after:absolute after:inset-0 after:bg-gradient-to-t after:from-zinc-900 after:to-zinc-800/10 after:backdrop-blur">
