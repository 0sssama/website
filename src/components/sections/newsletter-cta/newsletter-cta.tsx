...
export default function NewsletterCTA({
  ...
  return (
    <section className="pb-18 container relative flex flex-col overflow-hidden rounded-3xl bg-primary py-12 pb-6 drop-shadow-3xl max-lg:mx-5 md:items-center md:px-6">
      {title && (
      ...
      <div className="pointer-events-none absolute -top-20 bottom-0 left-0 right-0 z-[-1] rotate-180 bg-[linear-gradient(to_right,#a1a1aa_1px,transparent_1px),linear-gradient(to_bottom,#a1a1aa_1px,transparent_1px)] bg-[size:2.5rem_2.5rem] opacity-20 [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
    </section>
  );
}
